        ...
        <div class="container-fluid" id="admin-profile-desa">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="modal fade" id="editProfilDesaModal" tabindex="-1"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" id="editLayaAdminForm">
                                        ...
                                        <!-- Sejarah Desa -->
                                        <div class="form-group row mb-3">
                                            <label for="sejarahDesa" class="col-lg-2 col-md-3 col-sm-4 form-label">Sejarah
                                                Desa:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="misiDesa"
                                                class="col-lg-2 col-md-3 col-sm-4 form-label">Misi:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                        ...
                                        <div class="form-group row gx-3 gy-3">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="total_laki_laki" required
                                                    value="{{ $profiledesa->total_laki_laki }}">
                                            </div>
                                            <div class="col-lg-3 col-md-6">
                                                <label class="form-label">Total Perempuan:</label>
                                                <input type="number" class="form-control" name="total_perempuan"
                                                    required value="{{ $profiledesa->total_perempuan }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <div class="row gx-3 gy-2">
                                                    <div class="col-lg-2 col-md-3">
                                                        ...
                                                        <input type="number" class="form-control" name="total_melayu"
                                                            value="{{ $profiledesa->total_melayu }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                    <div class="col-lg-2 col-md-3">
                                                        <label class="form-label">Madura</label>
                                                        <input type="number" class="form-control" name="total_madura"
                                                            value="{{ $profiledesa->total_madura }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                    <div class="col-lg-2 col-md-3">
                                                        <label class="form-label">Tionghoa</label>
                                                        <input type="number" class="form-control" name="total_tionghoa"
                                                    ...
                                                    <div class="col-lg-2 col-md-3">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            ...
                                                            value="{{ $profiledesa->total_suku_lainnya }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <div class="row gx-3 gy-2">
                                                    ...
                                                    <div class="col-lg-2 col-md-3">
                                                        ...
                                                        <input type="number" class="form-control" name="total_katolik"
                                                            value="{{ $profiledesa->total_katolik }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                    <div class="col-lg-2 col-md-3">
                                                        <label for="agamaProtestan" class="form-label">Protestan</label>
                                                        <input type="number" class="form-control" name="total_protestan"
                                                            value="{{ $profiledesa->total_protestan }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                    <div class="col-lg-2 col-md-3">
                                                        <label for="agamaBuddha" class="form-label">Buddha</label>
                                                        <input type="number" class="form-control" name="total_buddha"
                                                            id="agamaBuddha" value="{{ $profiledesa->total_buddha }}"
                                                            placeholder="" min="0">
                                                    </div>
                                                    <div class="col-lg-2 col-md-3">
                                                    ...
                                                    <div class="col-lg-2 col-md-3">
                                                        ...
                                                        <input type="number" class="form-control" name="total_konghuchu"
                                                            value="{{ $profiledesa->total_konghuchu }}" placeholder=""
                                                            min="0">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Batas Desa -->
                                        <div class="form-group row mt-3 mb-3">
                                            <label for="batasUtaraDesa"
                                                class="col-lg-2 col-md-3 col-sm-4 form-label">Batas Utara:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="batasUtaraDesa"
                                                    name="batas_utara" required value="{{ $profiledesa->batas_utara }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3 mb-3">
                                            <label for="batasTimurDesa"
                                                class="col-lg-2 col-md-3 col-sm-4 form-label">Batas Timur:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="batasTimurDesa"
                                                    name="batas_timur" required value="{{ $profiledesa->batas_timur }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3 mb-3">
                                            <label for="batasSelatanDesa"
                                                class="col-lg-2 col-md-3 col-sm-4 form-label">Batas Selatan:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="batasSelatanDesa"
                                                    name="batas_selatan" required
                                                    value="{{ $profiledesa->batas_selatan }}">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-3 mb-3">
                                            <label for="batasBaratDesa"
                                                class="col-lg-2 col-md-3 col-sm-4 form-label">Batas Barat:</label>
                                            <div class="col-lg-10 col-md-9 col-sm-8">
                                                <input type="text" class="form-control" id="batasBaratDesa"
                                                    name="batas_barat" required value="{{ $profiledesa->batas_barat }}">
                                            </div>
                                        </div>
