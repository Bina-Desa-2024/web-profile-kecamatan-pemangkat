...
@section('child')
            ...
            <div class="row g-4 text-center">
                ...
                <div class="col-lg-6">
                    <div class="d-flex" style="border-radius:20px; padding:20px; background-color:#f1f1f1; ">
                        ...
                        <div class="d-flex flex-column justify-content-between p-1" style=" text-align: left;">
                            <span style="font-size: 30px; color:#286a59" class="fw-bold counter" data-target="{{ $profiledesa->total_jiwa }}">0</span>
                ...
                <div class="col-lg-6">
                    <div class="d-flex" style="border-radius:20px; padding:20px; background-color:#f1f1f1; ">
                        ...
                        <div class="d-flex flex-column justify-content-between p-1" style=" text-align: left;">
                            <span style="font-size: 30px; color:#286a59" class="fw-bold counter" data-target="{{ $profiledesa->total_kk }}">0</span>
                ...
                <div class="col-lg-6">
                    <div class="d-flex" style="border-radius:20px; padding:20px; background-color:#f1f1f1; ">
                        ...
                        <div class="d-flex flex-column justify-content-between p-1" style=" text-align: left;">
                            <span style="font-size: 30px; color:#286a59" class="fw-bold counter" data-target="{{ $profiledesa->total_laki_laki }}">0</span>
                ...
                <div class="col-lg-6">
                    <div class="d-flex" style="border-radius:20px; padding:20px; background-color:#f1f1f1; ">
                        ...
                        <div class="d-flex flex-column justify-content-between p-1" style=" text-align: left;">
                            <span style="font-size: 30px; color:#286a59" class="fw-bold counter" data-target="{{ $profiledesa->total_perempuan }}">0</span>
    ...
    <section id="kantor-desa" class="py-5">
        <div class="container transition-container col-lg-10 shadow-sm p-4 rounded">
            <!-- Section Title -->
            <h2 class="subjudul text-center mb-5 fw-bold">Lokasi Kecamatan</h2>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="card border-0 rounded-4" style="background-color: #f1f1f1; ">
                        <div class="card-body">
                            <h5 class="card-title fw-bold" style="color:#286a59">Informasi Kecamatan</h5>
                            <div class="d-flex flex-column">
                                <div class="d-flex justify-content-between gap-2">
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-circle-arrow-up" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Batas Utara</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->batas_utara }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-circle-arrow-down" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Batas Selatan</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->batas_selatan }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between gap-2">
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-circle-arrow-left" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Batas Barat</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->batas_barat }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-circle-arrow-right" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Batas Timur</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->batas_timur }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card border-0 rounded-4" style="background-color: #f1f1f1; ">
                        <div class="card-body">
                            <h5 class="card-title fw-bold" style="color:#286a59">Statistik Kecamatan</h5>
                            <div class="d-flex flex-column">
                                <div class="d-flex justify-content-between gap-2">
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-map" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Luas Desa</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->luas_desa }} km²</div>
                                        </div>
                                    </div>
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-layer-group" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Jumlah Desa</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->jumlah_dusun }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between gap-2">
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-solid fa-building" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Jumlah RT</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->jumlah_rt }}</div>
                                        </div>
                                    </div>
                                    <div class="d-flex rounded-3 bg-light mb-2 align-items-center w-100" style="padding:10px">
                                        <i class="fa-regular fa-building" style="font-size: 30px; margin-right:8px;color:#286a59;"></i>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bold" style="">Jumlah RW</div>
                                            <div class="" style="color: #286a59">{{ $profiledesa->jumlah_rw }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
